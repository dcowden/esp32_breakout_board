...
%PROG% pcb export dxf --output %OUT_FILE%\front-silkscreen.dxf --layers F.Fab,F.Silkscreen,Edge.Cuts  --output-units mm %SOURCE_FILE%
%PROG% pcb export svg --output %OUT_FILE%\writing-front.svg --black-and-white --theme "KiCad Classic" --layers F.Mask,F.Fab --exclude-drawing-sheet %SOURCE_FILE%
